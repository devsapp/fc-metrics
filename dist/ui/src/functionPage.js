...
const RequestTableList_1 = __importDefault(require("./components/RequestTableList"));
class PageInfo extends react_1.Component {
    render() {
        return (react_1.default.createElement(console_components_page_1.default, null,
            react_1.default.createElement(console_components_page_1.default.Content, null,
                ...
                react_1.default.createElement(RequestTableList_1.default, null))));
    }
}
exports.default = PageInfo;
//# sourceMappingURL=functionPage.js.map